...
func TestSplitWith(t *testing.T) {
	for i, tc := range []struct {
		...
		{
			// issue #109
			input:         "/home/devin/projects/@relay/kengine-bin@version",
			expectModule:  "/home/devin/projects/@relay/kengine-bin",
			expectVersion: "version",
		},
	} {
...
func TestNormalizeImportPath(t *testing.T) {
	...
	tests := testCaseType{
		{"linux-path", args{
			currentModule: "github.com/khulnasoft/xkengine",
			cwd:           "/xkengine",
			moduleDir:     "/xkengine",
		...
		{"linux-subpath", args{
			...
			cwd:           "/xkengine/subdir",
			moduleDir:     "/xkengine",
		}, "github.com/khulnasoft/xkengine/subdir"},
	}
	windowsTests := testCaseType{
		{"windows-path", args{
			currentModule: "github.com/khulnasoft/xkengine",
			cwd:           "c:\\xkengine",
			moduleDir:     "c:\\xkengine",
		}, "github.com/khulnasoft/xkengine"},
		{"windows-subpath", args{
			currentModule: "github.com/khulnasoft/xkengine",
			cwd:           "c:\\xkengine\\subdir",
			moduleDir:     "c:\\xkengine",
		}, "github.com/khulnasoft/xkengine/subdir"},
	}
