...
`))
	...
	expected := []xkengine.Replace{
		...
		xkengine.NewReplace("replacetest3", "/home/work/module/fork1"),
		xkengine.NewReplace("github.com/simnalamburt/module", "/home/work/module"),
		xkengine.NewReplace("replacetest4", "/srv/fork2"),
		xkengine.NewReplace("replacetest5", "/home/work/module/fork3"),
	}
