...
`))
	...
	expected := []xkengine.Replace{
		xkengine.NewReplace("replacetest1", "golang.org/x/example@v0.0.0-20210811190340-787a929d5a0d"),
		xkengine.NewReplace("replacetest2", "golang.org/x/example@v0.0.0-20210407023211-09c3a5e06b5d"),
		xkengine.NewReplace("replacetest3", "C:\\Users\\work\\module\\fork1"),
		xkengine.NewReplace("github.com/simnalamburt/module", "C:\\Users\\work\\module"),
		xkengine.NewReplace("replacetest4", "C:\\go\\fork2"),
		xkengine.NewReplace("replacetest5", "C:\\Users\\work\\module\\fork3"),
	}
